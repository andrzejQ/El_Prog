...
````
Choć zdania na temat jakości konwersji JPG za pomocą FFMPEG są podzielone. Zob. też [Hurtowe zmniejszanie dużych obrazów *.jpg](https://andrzejq.github.io/Office_S_Tips/system/2019/09/20/drobne_podpowiedzi_2.html#hurtowe-zmniejszanie-du%C5%BCych-obraz%C3%B3w-jpg) z użyciem IrfanCiew.
